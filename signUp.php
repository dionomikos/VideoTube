<!-- With the :: markup we can have access to a method defined inside a class, after we import it on our file first of course 
     Double colons can be used only inside static functions -->
<?php
...
if(isset($_POST["submitButton"])) {
    ...
    if($wasSuccessful) {
        ...
        // Session is actually an array so we start storing values
        $_SESSION["userLoggedIn"] = $username;
        // To make the redirection we use the header() method
